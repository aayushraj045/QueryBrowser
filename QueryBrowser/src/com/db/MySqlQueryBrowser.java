...
public class MySqlQueryBrowser extends JFrame
{
	  ...
	  private JButton cmd1,cmd2,cmd3,cmd4,cmd5,cmd6,cmd7,b1;
		  ...
		  table1.addActionListener(new ActionListener()
	       ...
	       table5.addActionListener(new ActionListener()
            ...
            @Override
	          ...
	          adv3.addActionListener(new ActionListener()
		      {
	...
	private void initToolbar()
		...
		cmd1.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent ae)
			{ 
				// QueryBrowserForm q=new QueryBrowserForm();
				// q.pack();
	...
	private void initTree()
	  {
	  	...
	  	try
	  	{
	  		root1=new DefaultMutableTreeNode("---------------"+cn.getCatalog()+"--------------");
	  		this.setTree();
	...
	private void setTree()
	   {
	   		...
	   		java.util.Iterator itr=Helper.getTables(cn);
	  		while(itr.hasNext())
	  		{
